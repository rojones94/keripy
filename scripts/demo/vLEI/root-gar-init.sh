...
kli incept --name rootgar1 --alias rootgar1 --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-1-sample.json
...
kli incept --name rootgar2 --alias rootgar2 --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-2-sample.json
