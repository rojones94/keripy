...
kli incept --name delegator --alias delegator --file ${KERI_DEMO_SCRIPT_DIR}/data/basic/delegator.json
...
kli multisig incept --name multisig1 --alias multisig1 --group multisig --file ${KERI_DEMO_SCRIPT_DIR}/data/basic/multisig-delegate-sample.json &
pid=$!
PID_LIST+=" $pid"
kli multisig incept --name multisig2 --alias multisig2 --group multisig --file ${KERI_DEMO_SCRIPT_DIR}/data/basic/multisig-delegate-sample.json &
pid=$!
PID_LIST+=" $pid"
