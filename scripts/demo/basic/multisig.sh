...
kli incept --name multisig1 --base "${KERI_TEMP_DIR}"  --alias multisig1 --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-1-sample.json
...
kli incept --name multisig2 --base "${KERI_TEMP_DIR}"  --alias multisig2 --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-2-sample.json
...
kli multisig incept --name multisig1 --base "${KERI_TEMP_DIR}"  --alias multisig1 --group multisig --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-sample.json &
pid=$!
PID_LIST+=" $pid"
kli multisig incept --name multisig2 --base "${KERI_TEMP_DIR}"  --alias multisig2 --group multisig --file ${KERI_DEMO_SCRIPT_DIR}/data/shared/multisig-sample.json &
pid=$!
PID_LIST+=" $pid"
