...
echo "Initialize and Unlock 2 agents"
...
echo "Create Delegate ID and Approve with Rotation of Delegator"
sleep 2
...
echo "Rotate Delegate ID and Approve with Rotation of Delegator"
sleep 3
